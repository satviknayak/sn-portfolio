  ...
  return <div className="relative">
    ...
    <div className="flex h-[55vh] sm:h-[85vh] w-full bg-img bg">
      ...
      <div className="flex-col m-auto">
        <div className="mx-auto flex h-[100px] sm:h-[150px] w-[100px] sm:w-[150px] rounded-full bg-profile bg"></div>
    ...
    <div id="Skills" className="flex flex-col relative h-[85vh] w-full bg bg-skill">
      <Navbar/>
